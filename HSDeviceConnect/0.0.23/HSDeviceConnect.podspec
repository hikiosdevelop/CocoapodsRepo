#
#  Be sure to run `pod spec lint HSDeviceConnect.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://EXAMPLE/HSDeviceConnect"
  ...
  spec.source       = { :svn => "https://192.0.0.140/HiStor/MobileAPP/IOS/PrivateCocoapods/HSDeviceConnect", :tag => "0.0.23" }
